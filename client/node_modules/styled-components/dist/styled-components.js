...
>>>>>>> release
    ...
    function createStylisInstance(_a) {
        ...
        prefix, componentId) {
            ...
            var stack = [];
            oe(compiled, ve(middlewares.concat(pe(function (value) { return stack.push(value); }))));
            return stack;
        };
    ...
    function css(styles) {
        ...
        if (isFunction(styles) || isPlainObject(styles)) {
            ...
            return addTag(flatten(interleave(EMPTY_ARRAY, __spreadArray([styleFunctionOrObject], interpolations, true))));
        }
